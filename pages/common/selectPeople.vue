	...
	export default {
		...
		methods: {
			...
			add() {
				...
				prevPage.$vm.parmas.trialBy = this.people.staffName;
				prevPage.$vm.parmas.trialId = this.people.id;   
				
				//uni.navigateTo跳转的返回，默认1为返回上一级
				uni.navigateBack({  
				    delta: 1
				});
				// this.parmas.trialBy = this.people.staffName
				// this.parmas.trialId = this.people.id
				// this.parmas.name=this.parmas.systemName
				// this.parmas.id=this.parmas.systemId
				// console.log(this.parmas,'跳转过来的值')
				// this.$Router.push({
				// 	name: 'dealEpPointInspection',
				// 	params: this.parmas
				// })
			},
